	...
	<section class="grid place-items-center text-center">
		<div class="flex w-full flex-col items-center" style:background-color="theme(colors.red.300)">
			<div class="mx-12 grid w-full max-w-xl animate-fadein select-none dark:[&>*]:fill-white">
				<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 400 200">
					<style type="text/css">
						.st0 {
							fill: #ec4444;
						}
					...
					<path
						class="st0"
						d="M341,19.3c6.1,0,11.7,1,17,3c5.2,2,9.8,4.7,13.7,8.1s6.9,7.4,9,11.9s3.2,9.4,3.2,14.6c0,5.8-0.6,10.9-1.8,15.5
					...
					/>
					<path
						d="M165.3,154.4c1.6,0.4,3.4,1.1,4.6,1.7l-1,2c-1.2-0.6-3.1-1.4-4.6-1.8L165.3,154.4z"
					/>
					<path
						d="M178.4,148.4c0.7,0.7,1.6,1.7,2.1,2.5l-1.1,0.8c-0.5-0.7-1.4-1.9-2.1-2.5L178.4,148.4z"
					/>
					<path d="M196,155.9h15v2.3h-14.3c-0.1,0.2-0.4,0.3-0.6,0.3L196,155.9z" />
					<path
						d="M27.4,128.9c-1.2-6.4-2.4-13.1-3.5-19.9c-1.1-6.9-2.1-13.7-3.1-20.5s-1.9-13.5-2.6-20c-0.8-6.5-1.4-12.5-2-18.2h18.9
			...
			<div
				class="mt-10 flex flex-col items-center justify-around child:rounded-xl child:text-lg child:font-medium sm:flex-row"
			>
				<a href="/catalog" class="flex items-center bg-red-500 py-3.5 px-5 text-white"
					>Search Icons</a
				>
				<a href="/docs" class="py-3.5 px-5 max-sm:mt-4">Read Details</a>
			</div>
		</div>
	</section>
