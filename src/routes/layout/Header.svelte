...
<nav
	class="fixed top-0 left-0 z-50 grid h-16 w-full grid-cols-2 justify-between bg-gradient-to-b from-white to-transparent px-4 py-3 dark:from-slate-800 [&_*]:outline-none"
>
	<a class="logo flex items-center" href="/">
		<div class="mr-2 h-9 w-20 translate-y-[2px] dark:[&>*]:fill-white">
			<svg data-name="Voyager2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 258 120">
